      ...
      <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        >
          ...
          <div className="mt-6 pt-6 border-t border-slate-200/60 text-center">
            <p className="text-sm text-slate-500 mb-4">Belum punya akun?</p>
            <Link
              to="/register"
              className="inline-flex justify-center w-full py-3.5 px-4 border border-emerald-200 text-sm font-bold rounded-xl text-emerald-700 bg-white hover:bg-emerald-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500 transition-all shadow-sm"
            >
              Buat Akun
            </Link>
          </div>
